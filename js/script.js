...
const setListoderEats = function() {
    ...
    for (let order of orderOptionsEatsSelect) {
        ...
        // console.log('orderOptionsEatsSelect----', order.querySelector('.countcake').value);
        dataOrderEats.push({
    ...
    // [...orderOptionsEatsSelect].forEach(order => {
    //         // console.log('orderOptionsEatsSelect ID----', order.querySelector('.checkcake').getAttribute('id'));
    //         //  console.log('orderOptionsEatsSelect----', order.querySelector('.countcake').value);
    //         dataOrderEats.push({
    //             id: order.getAttribute('data-id'),
    ...
    //         });
    //     })
    // console.log(' -----order  Select ----', dataOrderEats);
...
function orderArticlesClick(orderArticles) {
    ...
    [...orderArticles].forEach((element) => {
        element.addEventListener("click", () => {
            ...
            [...orderArticles].forEach((element1) => {
                    if (element1.classList.contains('toogleArticle')) {
                        element1.classList.remove('toogleArticle');
                    }
                })
